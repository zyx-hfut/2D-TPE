...
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port=20214 sft_minicpm_v2.py  \
        --model_name_or_path /data/zyx/model/MiniCPM-2B-sft-bf16-llama-format \
        --bf16 True \
        --output_dir ../output_v2/hitab_2d \
        --model_max_length 4096 \
        --use_flash_attn True \
        --data_path /data/zyx/dataset/TableInstruct/data_v3/hitab_train_7417.json \
        --val_ratio $VAL_RATIO \
